# -*- coding: utf-8 -*-
"""
Created on Sun Mar  3 18:59:02 2024
...
selected_data = Case_2[selected_columns]
...
np.save('MTFs_array_C2_500.npy', combined_MTFs)
...
# Save the array to a file
np.save('MTFs_array_condensed_C2.npy', combined_MTFs)
'''
